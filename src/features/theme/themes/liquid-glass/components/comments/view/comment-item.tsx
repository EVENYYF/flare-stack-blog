    ...
    return (
      <div
        ...
        className={cn(
          ...
          isReply
            ? "ml-3 pl-3 border-l border-white/25 dark:border-white/10 md:ml-8 md:pl-8 md:border-l-0"
            : "border-b border-white/25 dark:border-white/10",
          isHighlighted && "bg-white/25 dark:bg-white/10 -mx-4 px-4 rounded-[18px]",
          className,
        )}
      >
        {/* Avatar - Minimalist Text or Image */}
        <div className="shrink-0 pt-1">
          <div className="w-8 h-8 rounded-full bg-white/30 dark:bg-white/10 overflow-hidden flex items-center justify-center border border-white/40 dark:border-white/15">
