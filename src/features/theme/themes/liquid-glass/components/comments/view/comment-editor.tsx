...
export const CommentEditor = ({
  ...
  return (
    <div className="relative group/editor rounded-[22px] border border-white/35 bg-white/25 backdrop-blur-md transition-colors duration-300 hover:border-white/55 focus-within:bg-white/40 dark:border-white/10 dark:bg-white/10 dark:hover:border-white/20 dark:focus-within:bg-white/15 overflow-hidden">
      {/* Toolbar - Always visible at top */}
      <div className="border-b border-white/20 dark:border-white/10 p-1 sticky top-0 z-10 w-full">
      ...
      <div className="flex items-center justify-between px-4 pb-2 pt-2 border-t border-white/20 dark:border-white/10">
