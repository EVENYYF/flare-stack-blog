      ...
      {isReplyingToRoot && (
        <div className="py-6 ml-12 px-0 animate-in fade-in slide-in-from-top-2 duration-300">
          {session ? (
            ...
            <div className="flex items-center gap-4 py-3 bg-white/20 dark:bg-white/8 rounded-full px-4">
              ...
              <Link to="/login">
                <Button
                  variant="outline"
                  size="sm"
                  className="lg-control h-7 rounded-full px-3 text-xs font-medium"
                >
                  {m.comments_login()}
                </Button>
              </Link>
