...
import { getLiquidGlassThemeStyle } from "./theme-style";

/**
 * Theme: liquid-glass — implements the full ThemeComponents contract.
 * TypeScript will error at compile time if any required component is missing.
 */
export default {
  config,
  getDocumentStyle: getLiquidGlassThemeStyle,
  HomePage,
  HomePageSkeleton,
  PostsPage,
  PostsPageSkeleton,
